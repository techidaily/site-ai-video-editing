...
// ------------------------------------------------------------------------------------------- 以下内容需要自己替换
const subSiteAuthor = 'Morgan';
const subSiteKeywords = `video edit, ai video edit, video and ai` + ','; // 关键字，多个关键字用逗号分隔
const indexNowKey = 'da5d9fcc361a49d999f4ffb1928ba0b0'; // 替换为你的API密钥
